...
createServer({
  ...
  seeds(server) {
    server.db.loadData({
      transasions: [
        { id: 11, titleTransasion: "Pagamento conta de luz", selectCategory: 1, valueTrasasion: 500, data: new Date("2022-02-21"), type: 0 },
        { id: 22, titleTransasion: "compra de material de limpeza", selectCategory: 2, valueTrasasion: 100, data: new Date("2022-02-19"), type: 0 },
        ...
        { id: 55, titleTransasion: "Recebimento de pagaemnto", selectCategory: 4, valueTrasasion: 500, data: new Date("2022-02-12"), type: 1 },
